...
public class MainActivity extends AppCompatActivity implements ActionBar.TabListener{
    ...
    /**
     * Get categories and setup UI elements
     *
     */
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, Config.CATEGORY_URL,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        Log.d(TAG, "JSON Dump:\n" + jsonObject.toString());
                        //try {
                        //    FileOutputStream fOut = openFileOutput("cat",MODE_WORLD_READABLE);
     ...
     */
    private void createTabs(String[] categories) {
        //actionBar.removeAllTabs();
        for (String cat : categories) {
            Log.d(TAG, "Creating tab for " + cat);
    ...
    public void onTabSelected(ActionBar.Tab tab, FragmentTransaction ft) {
        ...
        ft.replace(android.R.id.content, plf);
    }
    ...
    //    try {
    //        FileInputStream fin = openFileInput("cat");
    //
    //        int c;
    //        String temp="";
    //        while( (c = fin.read()) != -1){
    ...
    //            categoryArray[i+1] = cat.getString("title");
    //            categoryIdArray[i+1] = cat.getInt("id");
    //        }
    //
    //        fin.close();
    //
